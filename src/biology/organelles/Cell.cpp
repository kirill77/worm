...
void Cell::checkCellCycleTransitions()
{
    ...
    double fCdk1 = internalMedium.getMoleculeNumber(Molecule(StringDict::idToString(StringDict::ID::CDK_1), ChemicalType::PROTEIN), center);
    double fCyclinB = internalMedium.getMoleculeNumber(Molecule(StringDict::idToString(StringDict::ID::CYB_1), ChemicalType::PROTEIN), center);
    double fPlk1 = internalMedium.getMoleculeNumber(Molecule(StringDict::idToString(StringDict::ID::PLK_1), ChemicalType::PROTEIN), center);
