...
float3 Spindle::calculatePARBasedForces(const Medium& medium) const
{
    ...
    for (int i = 0; i < NUM_SAMPLES; ++i)
    {
        ...
        double anteriorPARs = medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_3, ChemicalType::PROTEIN), anteriorPoint) +
                              medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_6, ChemicalType::PROTEIN), anteriorPoint) +
                              medium.getMoleculeConcentration(Molecule(StringDict::ID::PKC_3, ChemicalType::PROTEIN), anteriorPoint);
        ...
        double posteriorPARs = medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_1, ChemicalType::PROTEIN), posteriorPoint) +
                               medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_2, ChemicalType::PROTEIN), posteriorPoint);
...
float3 Spindle::calculatePreferredOrientation(const Medium& medium) const
{
    switch (m_cellType)
    {
        ...
        case CellType::Germline3:
        {
            ...
            double anteriorPARs = medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_3, ChemicalType::PROTEIN), anterior) +
                                  medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_6, ChemicalType::PROTEIN), anterior) +
                                  medium.getMoleculeConcentration(Molecule(StringDict::ID::PKC_3, ChemicalType::PROTEIN), anterior);
            
            double posteriorPARs = medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_1, ChemicalType::PROTEIN), posterior) +
                                   medium.getMoleculeConcentration(Molecule(StringDict::ID::PAR_2, ChemicalType::PROTEIN), posterior);
